        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            switch (gameState)
            {
                case GameState.startScreen:
                    ...
                    break;
                case GameState.menu:
                    menu.Draw(spriteBatch, spritesheet,font, startedGame);
                    break;
                case GameState.levelTransition:
                    spriteBatch.Draw(levelCompleted, new Vector2(0, 0), Color.White);
                    spriteBatch.DrawString(font, "Kills this level: " + player.kills.ToString(), new Vector2(20, 140),Color.White);
                    spriteBatch.DrawString(font, "Score: " + player.score.ToString(), new Vector2(20, 240), Color.White);
                    break;
                case GameState.game:
                    switch (level)
                    {
